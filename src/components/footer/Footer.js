  ...
  return (
    <footer className="footer">
      <div className="container">
        <span className="text-muted">Benjamin Wills: Data Engineer</span>
        <div className="icon-container">
          ...
          <div className="icon">
            <a href="mailto:benjaminwills047@gmail.com"><FontAwesomeIcon icon={faEnvelope} style={{ color: 'black' }} className="contact-icon" /></a>
          </div>
        </div>
      </div>
    </footer>
